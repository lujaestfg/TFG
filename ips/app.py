...
<iframe src="http://192.168.1.222/d/9efe89e9-11e7-4267-8bc1-7731da6b9a05/ids-dashboard?orgId=1&from=now-1h&to=now&timezone=browser&var-namespace=$__all&var-pod=$__all&theme=light&kiosk=tv"
    id="grafanaFrame"
