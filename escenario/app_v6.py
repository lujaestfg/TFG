...
<table id="labeledTable">
  ...
  <tbody id="labeledBody"></tbody>
    ...
    <div id="grafanaSection" class="section">
      <h2 class="section-title">Panel de Grafana</h2>
<iframe src="http://grafana.siem.svc:3000/d-solo/db78a76a-70a0-4ed6-a451-8eb77fed255b/suricata-logs?orgId=1&from=1749206196197&to=1749227796197&timezone=browser&panelId=1&__feature.dashboardSceneSolo" width="450" height="200" frameborder="0"></iframe>
    </div>
  </div>
</body>
</html>
